...
import { ArrowLeft, CheckCircle2, Download, MapPin, ShieldCheck } from "lucide-react";
              ...
              <div className="space-y-5">
                {view.items.map((item) => (
                  <div key={item.id} className="flex flex-col sm:flex-row gap-5 p-5 rounded-xl bg-[#FDFBF7] border border-brand-dark/5 items-start sm:items-center">
                    <div className="w-20 h-20 shrink-0 bg-white rounded-md overflow-hidden border border-brand-dark/5">
